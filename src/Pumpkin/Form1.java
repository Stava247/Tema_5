...
public class Form1 extends javax.swing.JFrame {
    ...
    public class MyPicture extends JPanel { // КЛАСС РИСОВАНИЯ СВОЕЙ КАРТИНКИ
        ...
        MyPicture() {
            ...
            Line2D line = new Line2D.Double(127, 100, 130, 92);
            canvas.setPaint(Color.GREEN);
            canvas.draw(line);
            
            Line2D line_2 = new Line2D.Double(128, 100, 131, 92);
            canvas.setPaint(Color.BLACK);
            canvas.draw(line_2);      
                ...
                generalPath9.moveTo(140, 150); // нач. точка
                generalPath9.lineTo(145, 145);    
                canvas.draw(generalPath9);
            
                GeneralPath generalPath6 = new GeneralPath();
                generalPath6.moveTo(121, 150); // нач. точка
                generalPath6.lineTo(120, 145);    
                canvas.draw(generalPath6);
                
                GeneralPath generalPath7 = new GeneralPath();
                generalPath6.moveTo(121, 150); // нач. точка
                generalPath6.lineTo(120, 145);    
                canvas.draw(generalPath7);
                
                GeneralPath generalPath8 = new GeneralPath();
                generalPath6.moveTo(121, 150); // нач. точка
                generalPath6.lineTo(120, 145);    
                canvas.draw(generalPath8);
                
                GeneralPath generalPath = new GeneralPath();
                generalPath.moveTo(120, 100); // нач. точка
                generalPath.lineTo(115, 105);    
                canvas.draw(generalPath);
                
                GeneralPath generalPath5 = new GeneralPath();
                generalPath5.moveTo(150, 105); // нач. точка
                generalPath5.lineTo(152, 107);    
                canvas.draw(generalPath5);
                
                GeneralPath generalPath4 = new GeneralPath();
                generalPath4.moveTo(135, 100); // нач. точка
                generalPath4.lineTo(140, 102);    
                canvas.draw(generalPath4);

                // Глаза
                GeneralPath generalPath2 = new GeneralPath();
                generalPath2.moveTo(115, 120); // нач. точка
                generalPath2.lineTo(125, 120);
                generalPath2.moveTo(115, 120);
                generalPath2.lineTo(120, 110);
                generalPath2.moveTo(115, 120);
                generalPath2.lineTo(120, 110);
                generalPath2.moveTo(120, 110);
                generalPath2.lineTo(125, 120);
                canvas.draw(generalPath2);

                GeneralPath generalPath3 = new GeneralPath();
                generalPath3.moveTo(135, 120); // нач. точка
                generalPath3.lineTo(145, 120);
                generalPath3.moveTo(135, 120);
                generalPath3.lineTo(140, 110);
                generalPath3.moveTo(140, 110);
                generalPath3.lineTo(145, 120);
                canvas.draw(generalPath3);
                
                // Улыбка
                QuadCurve2D quadCurve2D = new QuadCurve2D.Double(117, 130, 130, 150, 145, 130);
              //  QuadCurve2D quadCurve2D = new QuadCurve2D.Double(x, y, ERROR, ERROR, x, y)
                canvas.draw(quadCurve2D);

                // Нос
                QuadCurve2D quadCurve2D2 = new QuadCurve2D.Double(128, 127, 130, 120, 133, 127);
                //  QuadCurve2D quadCurve2D = new QuadCurve2D.Double(x, y, ERROR, ERROR, x, y)
                canvas.draw(quadCurve2D2);

            //устанавливаем стиль и пишим текст
            canvas.setFont(new Font("Tahoma", Font.BOLD | Font.BOLD, 20));
            canvas.drawString("С.Е.А. - 10 вариант", 40, 240);
        }
    ...
    private void initComponents() {
        ...
        jPanel1.setBounds(0, 0, 280, 290);

        setSize(new java.awt.Dimension(296, 324));
